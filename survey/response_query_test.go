...
func TestParseResonseQuery_Valid(t *testing.T) {
    tests := []struct {
        name  string
        input string
        want  ResponseQuery
    ...
    for _, tt := range tests {
        t.Run(tt.name, func(t *testing.T) {
            ...
            if !reflect.DeepEqual(*got, tt.want) {
                t.Errorf("ParseResponseQuery() = %+v, want %+v", *got, tt.want)
            }
        })
    }
}

func TestParseResponseQuery_Invalid(t *testing.T) {
    tests := []struct {
        name  string
        input string
    }{
        {"invalid range endpoints", "keys:foo;range:[foo..bar]"},
        {"empty keys", "keys: ; range:[0..5]"},
...
func TestResponseQuery_Limit(t *testing.T) {
    ...
    makeResp := func(id int) Response {
        return Response{"id": ResponseValue{Val: id}}
    }
    responses := []Response{
    ...
    tests := []struct {
    ...
    }{
        {
            ...
            []Response{makeResp(0), makeResp(1), makeResp(2), makeResp(3), makeResp(4), makeResp(5)},
        },
        {
            "first 3",
            ResponseQuery{
            ...
            []Response{makeResp(0), makeResp(1), makeResp(2)},
        },
        {
            "last 2",
            ResponseQuery{
            ...
            []Response{makeResp(4), makeResp(5)},
        },
        {
            "middle slice",
            ResponseQuery{
            ...
            []Response{makeResp(2), makeResp(3), makeResp(4)},
        },
        {
            "last-2 to last",
            ResponseQuery{
            ...
            []Response{makeResp(3), makeResp(4), makeResp(5)},
        },
    }
    for _, tt := range tests {
        t.Run(tt.name, func(t *testing.T) {
